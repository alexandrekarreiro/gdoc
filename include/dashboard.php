...
$result = "SELECT * FROM projetos WHERE nome LIKE '%$pesquisar%' AND data LIKE '%$pesq_data%' AND user LIKE '%$pesq_user%'  AND status LIKE '%$pesq_status%'ORDER BY data DESC LIMIT 1000";
